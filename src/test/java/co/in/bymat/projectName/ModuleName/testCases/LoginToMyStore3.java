...
public class LoginToMyStore3 extends TestBase_B9{
	...
	public void loginToMyStore3(Hashtable<String, String> htdata) throws Exception {
		
		//test = report.startTest("loginToMyStore3");
